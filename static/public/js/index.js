...
function getAboutBlank() {
    if (localStorage.getItem('aboutBlank') === 'on') {
        ...
        introText.innerHTML = "<b>Helpster:</b><br>One of the primary reasons why math is important is that it helps us to develop logical thinking and problem-solving skills. When we solve math problems, we must carefully consider the information given to us and determine the best way to approach the problem. This process requires us to analyze, evaluate, and synthesize information, which are all important skills that are useful in many different fields. Math is also important because it is used in many practical applications. For example, it is used in the design and construction of buildings, bridges, and other structures. It is also used in the field of finance to calculate things like investments, mortgages, and insurance premiums. In addition, math is used in the field of computer science to create algorithms and write software programs. <br> Another reason why math is important is that it is a universal language. It is used in every country and culture around the world, which makes it a valuable tool for communication and collaboration. For example, if a scientist in the United States wants to share their research with a colleague in China, they can use math to present their findings in a way that is easily understood by someone who speaks a different language.<br> Finally, math is important because it helps us to understand the world around us. Many natural phenomena, such as the orbits of planets and the growth of plants, can be described and understood using math. By studying math, we can gain a greater understanding of the world and how it works, which can lead to new discoveries and innovations.</a>"
